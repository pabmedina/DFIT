...
nombreCorrida     = 'DFIT_DFIT_CorteAumentado_Qextendido_buff'; % Nombre de la corrida. La corrida se guarda en la carpeta "Resultado de corridas" en una subcarpeta con este nombre.
