function [meshInfo,cohesivosProperties] = setCohesivosPropertiesLabelCorteModificado( meshInfo,physicalProperties,temporalProperties,bombaProperties,key,key2,varargin )
...
elseif strcmpi(key2,'change')
    ...
    cohesivosProperties.TS0_1 = 1000*cohesivosProperties.tensionRoturaCohesivoS* psi2MPa;
