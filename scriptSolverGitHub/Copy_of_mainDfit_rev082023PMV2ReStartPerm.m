...
clearvars -except kappa nCase iCase iKappa nKappa factorImprove permFactor
set(0,'DefaultFigureWindowStyle','docked');
mainFolder = 'D:\Corridas\Paper geomec DFN\Santi\DFIT 7 del 23\DFIT\';

numeroDeCaso = 1;%5
caseName = 'WIplusDFNsBuffv2'; %'weakInterf'; %'noFeatures'; %'tripleInts';%
    ...
    elseif isipKC && algorithmProperties.elapsedTime >= temporalProperties.tInicioISIP % Se establece el valor de permeabilidad mas elevado para el SRV que se activa durante la produccion. 
        ...
        if KeyInicioIsip
            ...
            if wantBuffPermeability
                ...
                ImproveFactor=1-(1-permFactor)*(DeltaPHidro)./abs(tensionHidroDrainTimes);
