function [elements,nodesNew,nodosFluidos,elementsBarra,EBindex,intRelations] = gapInterseccionesEBYX(nodesINTindex,nodesNew,gap,elementsPlusX,elementsPlusY,elements,nodosFluidos,elementsBarra,EBindex,i,j)
