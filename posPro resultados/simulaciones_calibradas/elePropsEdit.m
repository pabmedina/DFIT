function [constitutivas, Biot, meshProps]= elePropsEdit(physicalProperties,nodes,elements,upg,key,key2,biot)
...
meshProps.nu_H = interp1(physicalProperties.constitutive.depth,physicalProperties.constitutive.NUh,nodes(:,3));
meshProps.nu_V = interp1(physicalProperties.constitutive.depth,physicalProperties.constitutive.NUv,nodes(:,3));
